...
public class DES {
  ...
  */
  ...
  public void decryptOp(byte in[], int inOff, byte out[], int outOff) throws Exception
  {
  ...
  public void encryptOp(byte in[], int inOff, byte out[], int outOff) throws Exception
  {
       //added by Selena
      if (!keyInited)
      {
  ...
  void ProcessBlock(byte inBlock[], int inOff, byte outBlock[], int outOff, int k[])
  {
    int work, work1;
