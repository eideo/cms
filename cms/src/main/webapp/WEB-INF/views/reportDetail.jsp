...
<head>
	...
	<myCss>
		...
		<link rel="stylesheet" type="text/css" href="${resPath}/resources/commons/css/reportPage.css?v=1.0.1-20151229">
	</myCss>
	<myScript>
		<script type="text/javascript" src="${resPath}/resources/commons/js/jquery-1.7.2.min.js?v=1.0.1-20151229"></script>
		<script type="text/javascript" src="${resPath}/resources/commons/js/reportPage.js?v=1.0.1-20151229"></script>
