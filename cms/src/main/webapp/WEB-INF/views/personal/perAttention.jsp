		...
		<div class="sign">
		    ...
		    <div class="personal_center">
				...
				<ul>
					...
					<li><a href="${appPath}/personal/attention" class="active">我的关注</a></li>
...
<myScript>
	...
	<script type="text/javascript" src="${resPath}/resources/commons/js/user/userAttention.js?v=${projectversion}"></script>
