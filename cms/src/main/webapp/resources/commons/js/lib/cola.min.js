...
! function(a) {
	function b(a, b, c, e, f) {
		...
		function i(a, b) {
			...
			for (var f = p = t, g = q = l(a), h = 0, i = Number.MAX_VALUE, k = Number.MAX_VALUE, m = -1, n = Number.MAX_VALUE, o = Number.MAX_VALUE; n > t || o > d.FLOAT_EPSILON;) {
				if (1 != m) var p = g - (g - f) / d.GOLDEN_SECTION,
					i = j(a, p);
				if (0 != m) var q = f + (g - f) / d.GOLDEN_SECTION,
					k = j(a, q);
				if (n = Math.abs(p - q), o = Math.abs(i - k), c > i && (c = i, e = p), c > k && (c = k, e = q), i > k ? (f = p, p = q, i = k, m = 1) : (g = q, q = p, k = i, m = 0), h++ > 100) break
			}
			j(a, e)
		}
		...
		function k(a, b) {
			for (var c = void 0, e = 0; e < v.length; e++)
				if (v[e].space_left >= a.height && v[e].x + v[e].width + a.width + d.PADDING - b <= d.FLOAT_EPSILON) {
					c = v[e];
					break
				}
			v.push(a), void 0 !== c ? (a.x = c.x + c.width + d.PADDING, a.y = c.bottom, a.space_left = a.height, a.bottom = a.y, c.space_left -= a.height + d.PADDING, c.bottom += a.height + d.PADDING) : (a.y = u, u += a.height + d.PADDING, a.x = n, a.bottom = a.y, a.space_left = a.height), a.y + a.height - s > -d.FLOAT_EPSILON && (s = a.y + a.height - o), a.x + a.width - r > -d.FLOAT_EPSILON && (r = a.x + a.width - n)
		}

		function l(a) {
			var b = 0;
			return a.forEach(function(a) {
				return b += a.width + d.PADDING
			}), b
		}
	...
	a.applyPacking = b, a.separateGraphs = c
}(cola || (cola = {}));
var cola;
! function(a) {
	var b;
...
! function(a) {
	...
	! function(a) {
		...
		var d = function() {
			...
			e = function(a) {
				function b(b) {
					a.call(this), this._root = null, this._comparator = b, this.size = 0
				}
				return __extends(b, a), b.prototype.insert = function(a) {
					var c = !1;
					if (null === this._root) this._root = new d(a), c = !0, this.size++;
					else {
						var e = new d(void 0),
							f = !1,
							g = !1,
						...
						for (i.right = this._root;;) {
							if (null === k ? (k = new d(a), j.set_child(f, k), c = !0, this.size++) : b.is_red(k.left) && b.is_red(k.right) && (k.red = !0, k.left.red = !1, k.right.red = !1), b.is_red(k) && b.is_red(j)) {
								var l = i.right === h;
								k === j.get_child(g) ? i.set_child(l, b.single_rotate(h, !g)) : i.set_child(l, b.double_rotate(h, !g))
							}
							var m = this._comparator(k.data, a);
							if (0 === m) break;
							g = f, f = 0 > m, null !== h && (i = h), h = j, j = k, k = k.get_child(f)
						}
						this._root = e.right
					}
					...
					var c = new d(void 0),
						e = c;
					e.right = this._root;
					for (var f = null, g = null, h = null, i = !0; null !== e.get_child(i);) {
						var j = i;
						g = f, f = e, e = e.get_child(i);
						var k = this._comparator(a, e.data);
						if (i = k > 0, 0 === k && (h = e), !b.is_red(e) && !b.is_red(e.get_child(i)))
							if (b.is_red(e.get_child(!i))) {
								var l = b.single_rotate(e, i);
								f.set_child(j, l), f = l
							} else if (!b.is_red(e.get_child(!i))) {
							var m = f.get_child(!j);
							if (null !== m)
								if (b.is_red(m.get_child(!j)) || b.is_red(m.get_child(j))) {
									var n = g.right === f;
									b.is_red(m.get_child(j)) ? g.set_child(n, b.double_rotate(f, j)) : b.is_red(m.get_child(!j)) && g.set_child(n, b.single_rotate(f, j));
									var o = g.get_child(n);
									o.red = !0, e.red = !0, o.left.red = !1, o.right.red = !1
								} else f.red = !1, m.red = !0, e.red = !0
						}
					}
					return null !== h && (h.data = e.data, f.set_child(f.right === e, e.get_child(null === e.left)), this.size--), this._root = c.right, null !== this._root && (this._root.red = !1), null !== h
				}, b.is_red = function(a) {
					return null !== a && a.red
...
! function(a) {
	...
	! function(a) {
		...
		function f() {
			return new a.RBTree(function(a, b) {
				return a.pos - b.pos
			})
		}
		...
		var v = function() {
			function c(c, d, e, f, g) {
				...
				if (void 0 === e && (e = null), void 0 === f && (f = null), void 0 === g && (g = !1), this.nodes = c, this.groups = d, this.rootGroup = e, this.avoidOverlaps = g, this.variables = c.map(function(a, b) {
					...
					d.forEach(function(a) {
						h.variables[i] = a.minVar = new u(i++, "undefined" != typeof a.stiffness ? a.stiffness : .01), h.variables[i] = a.maxVar = new u(i++, "undefined" != typeof a.stiffness ? a.stiffness : .01)
					})
				}
			}
			return c.prototype.createSeparation = function(b) {
				...
				this.setupVariablesAndBounds(a, c, e, f), this.rootGroup && this.avoidOverlaps && (b(this.rootGroup), g = g.concat(h(this.rootGroup))), this.solve(this.variables, g, d, e), this.nodes.forEach(i), this.rootGroup && this.avoidOverlaps && (this.groups.forEach(j), b(this.rootGroup))
...
! function(a) {
	...
	var c = function() {
		function a(a, c, e) {
			void 0 === e && (e = null), this.D = c, this.G = e, this.threshold = 1e-4, this.numGridSnapNodes = 0, this.snapGridSize = 100, this.snapStrength = 1e3, this.scaleSnapByMaxH = !1, this.random = new d, this.project = null, this.x = a, this.k = a.length;
		...
		return a.createSquareMatrix = function(a, b) {
			...
			if (!(1 > c)) {
				...
				for (var v = this.snapGridSize / 2, w = this.snapGridSize, x = this.snapStrength, y = x / (v * v), z = this.numGridSnapNodes, i = 0; z > i; ++i)
					for (d = 0; d < this.k; ++d) {
						var A = this.x[d][i],
							B = A / w,
							C = B % 1,
							D = B - C,
							E = Math.abs(C),
							m = .5 >= E ? A - D * w : A > 0 ? A - (D + 1) * w : A - (D - 1) * w;
						m > -v && v >= m && (this.scaleSnapByMaxH ? (this.g[d][i] += h * y * m, this.H[d][i][i] += h * y) : (this.g[d][i] += y * m, this.H[d][i][i] += y))
					}
	...
	! function(a) {
		function b(a, c, d) {
			a.forAll(function(a) {
				if (a.isLeaf()) c.leaves || (c.leaves = []), c.leaves.push(a.id);
					...
					var e = c;
					if (a.gid = d.length, !a.isIsland() || a.isPredefined()) {
						if (e = {
								id: a.gid
							}, a.isPredefined())
							for (var f in a.definition) e[f] = a.definition[f];
						c.groups || (c.groups = []), c.groups.push(a.gid), d.push(e)
					}
					b(a.children, e, d)
				}
			})
			...
			return a.prototype.initModulesFromGroup = function(a) {
				...
				if (a.groups)
					for (var f = 0; f < a.groups.length; ++f) {
						var j = a.groups[f],
							k = {};
						for (var l in j) "leaves" !== l && "groups" !== l && j.hasOwnProperty(l) && (k[l] = j[l]);
						b.add(new g(-1 - f, new i, new i, this.initModulesFromGroup(j), k))
					}
				return b
		...
		var g = function() {
			function a(a, b, c, d, e) {
				void 0 === b && (b = new i), void 0 === c && (c = new i), void 0 === d && (d = new h), this.id = a, this.outgoing = b, this.incoming = c, this.children = d, this.definition = e
			}
			return a.prototype.getEdges = function(a) {
				...
				return "undefined" != typeof this.definition
			}, a
		}();
		a.Module = g;
		var h = function() {
	...
	function i(a, b, c) {
		function d(a) {
			...
			for (var b = 0, c = a.out; b < c.length; b++) {
				var e = c[b];
				"undefined" == typeof e.index ? (d(e), a.lowlink = Math.min(a.lowlink, e.lowlink)) : e.onStack && (a.lowlink = Math.min(a.lowlink, e.index))
			}
		...
		for (var e = [], f = 0, g = [], h = [], i = 0; a > i; i++) e.push({
			id: i,
			out: []
		});
		for (var j = 0; j < b.length; j++) {
			var k = b[j],
				l = e[c.getSourceIndex(k)],
				m = e[c.getTargetIndex(k)];
			l.out.push(m)
		}
		for (var n = 0; n < e.length; n++) {
			var o = e[n];
			"undefined" == typeof o.index && d(o)
		}
		return h
	}
	a.symmetricDiffLinkLengths = f, a.jaccardLinkLengths = g, a.generateDirectedEdgeConstraints = h, a.stronglyConnectedComponents = i
}(cola || (cola = {}));
...
! function(a) {
	function b(a) {
		return "undefined" != typeof a.leaves || "undefined" != typeof a.groups
	}! function(a) {
		...
		d = function() {
			function d() {
				...
				this._canvasSize = [1, 1], this._linkDistance = 20, this._defaultNodeSize = 10, this._linkLengthCalculator = null, this._linkType = null, this._avoidOverlaps = !1, this._handleDisconnected = !0, this._running = !1, this._nodes = [], this._groups = [], this._rootGroup = null, this._links = [], this._constraints = [], this._distanceMatrix = null, this._descent = null, this._directedLinkConstraints = null, this._threshold = .01, this._visibilityGraph = null, this._groupCompactness = 1e-6, this.event = null, this.linkAccessor = {
					getSourceIndex: d.getSourceIndex,
					getTargetIndex: d.getTargetIndex,
					setLength: d.setLinkLength,
					getType: function(b) {
						return "function" == typeof a._linkType ? a._linkType(b) : 0
					}
				}
			}
			return d.prototype.on = function(a, b) {
				return this.event || (this.event = {}), "string" == typeof a ? this.event[c[a]] = b : this.event[a] = b, this
			}, d.prototype.trigger = function(a) {
				this.event && "undefined" != typeof this.event[a.type] && this.event[a.type](a)
			}, d.prototype.kick = function() {
				for (; !this.tick(););
				...
				var a, b, d = this._nodes.length;
				this._links.length;
				for (this._descent.locks.clear(), b = 0; d > b; ++b)
					if (a = this._nodes[b], a.fixed) {
						("undefined" == typeof a.px || "undefined" == typeof a.py) && (a.px = a.x, a.py = a.y);
						var e = [a.px, a.py];
						this._descent.locks.add(b, e)
					}
				var f = this._descent.rungeKutta();
				return 0 === f ? this._alpha = 0 : "undefined" != typeof this._lastStress && (this._alpha = f), this._lastStress = f, this.updateNodePositions(), this.trigger({
					type: c.tick,
					alpha: this._alpha,
					stress: this._lastStress
				}), !1
			}, d.prototype.updateNodePositions = function() {
				for (var a, b = this._descent.x[0], c = this._descent.x[1], d = this._nodes.length; d--;) a = this._nodes[d], a.x = b[d], a.y = c[d]
			}, d.prototype.nodes = function(a) {
				if (!a) {
					if (0 === this._nodes.length && this._links.length > 0) {
						...
						for (var c = 0; b > c; ++c) this._nodes[c] = {}
					}
					return this._nodes
				}
				return this._nodes = a, this
			}, d.prototype.groups = function(a) {
				var b = this;
				return a ? (this._groups = a, this._rootGroup = {}, this._groups.forEach(function(a) {
					"undefined" == typeof a.padding && (a.padding = 1), "undefined" != typeof a.leaves && a.leaves.forEach(function(c, d) {
						(a.leaves[d] = b._nodes[c]).parent = a
					}), "undefined" != typeof a.groups && a.groups.forEach(function(c, d) {
			...
			}, d.prototype.powerGraphGroups = function(b) {
				var c = a.powergraph.getGroups(this._nodes, this._links, this.linkAccessor, this._rootGroup);
				return this.groups(c.groups), b(c), this
			}, d.prototype.avoidOverlaps = function(a) {
				return arguments.length ? (this._avoidOverlaps = a, this) : this._avoidOverlaps
			}, d.prototype.handleDisconnected = function(a) {
				return arguments.length ? (this._handleDisconnected = a, this) : this._handleDisconnected
			}, d.prototype.flowLayout = function(a, b) {
			...
			}, d.prototype.links = function(a) {
				return arguments.length ? (this._links = a, this) : this._links
			}, d.prototype.constraints = function(a) {
				return arguments.length ? (this._constraints = a, this) : this._constraints
			}, d.prototype.distanceMatrix = function(a) {
				return arguments.length ? (this._distanceMatrix = a, this) : this._distanceMatrix
			}, d.prototype.size = function(a) {
				return a ? (this._canvasSize = a, this) : this._canvasSize
			}, d.prototype.defaultNodeSize = function(a) {
				return a ? (this._defaultNodeSize = a, this) : this._defaultNodeSize
			}, d.prototype.groupCompactness = function(a) {
				return a ? (this._groupCompactness = a, this) : this._groupCompactness
			}, d.prototype.linkDistance = function(a) {
				return a ? (this._linkDistance = "function" == typeof a ? a : +a, this._linkLengthCalculator = null, this) : this._linkDistance
			}, d.prototype.linkType = function(a) {
				return this._linkType = a, this
			}, d.prototype.convergenceThreshold = function(a) {
				return a ? (this._threshold = "function" == typeof a ? a : +a, this) : this._threshold
			}, d.prototype.alpha = function(a) {
				return arguments.length ? (a = +a, this._alpha ? a > 0 ? this._alpha = a : this._alpha = 0 : a > 0 && (this._running || (this._running = !0, this.trigger({
					type: c.start,
					alpha: this._alpha = a
				}), this.kick())), this) : this._alpha
			}, d.prototype.getLinkLength = function(a) {
				return "function" == typeof this._linkDistance ? +this._linkDistance(a) : this._linkDistance
			}, d.setLinkLength = function(a, b) {
				a.length = b
			}, d.prototype.getLinkType = function(a) {
				return "function" == typeof this._linkType ? this._linkType(a) : 0
			}, d.prototype.symmetricDiffLinkLengths = function(b, c) {
				var d = this;
				return void 0 === c && (c = 1), this.linkDistance(function(a) {
					return b * a.length
				}), this._linkLengthCalculator = function() {
					return a.symmetricDiffLinkLengths(d._links, d.linkAccessor, c)
				}, this
			}, d.prototype.jaccardLinkLengths = function(b, c) {
				var d = this;
				return void 0 === c && (c = 1), this.linkDistance(function(a) {
					return b * a.length
				}), this._linkLengthCalculator = function() {
					return a.jaccardLinkLengths(d._links, d.linkAccessor, c)
				}, this
			}, d.prototype.start = function(b, c, e, f, g) {
				var h = this;
				void 0 === b && (b = 0), void 0 === c && (c = 0), void 0 === e && (e = 0), void 0 === f && (f = 0), void 0 === g && (g = !0);
				var i, j = this.nodes().length,
					k = j + 2 * this._groups.length,
					l = (this._links.length, this._canvasSize[0]),
					m = this._canvasSize[1];
				this._linkLengthCalculator && this._linkLengthCalculator();
				var n = new Array(k),
					o = new Array(k),
					p = null,
					q = this._avoidOverlaps;
				this._nodes.forEach(function(a, b) {
					a.index = b, "undefined" == typeof a.x && (a.x = l / 2, a.y = m / 2), n[b] = a.x, o[b] = a.y
				});
				var r;
				this._distanceMatrix ? r = this._distanceMatrix : (r = new a.shortestpaths.Calculator(k, this._links, d.getSourceIndex, d.getTargetIndex, function(a) {
					return h.getLinkLength(a)
				}).DistanceMatrix(), p = a.Descent.createSquareMatrix(k, function() {
					return 2
				}), this._links.forEach(function(a) {
					"number" == typeof a.source && (a.source = h._nodes[a.source]), "number" == typeof a.target && (a.target = h._nodes[a.target])
				}), this._links.forEach(function(a) {
					var b = d.getSourceIndex(a),
						c = d.getTargetIndex(a);
					p[b][c] = p[c][b] = a.weight || 1
				}));
				var s = a.Descent.createSquareMatrix(k, function(a, b) {
					return r[a][b]
				});
				if (this._rootGroup && "undefined" != typeof this._rootGroup.groups) {
					var i = j,
						t = function(a, b, c, d) {
							p[a][b] = p[b][a] = c, s[a][b] = s[b][a] = d
						};
					this._groups.forEach(function(a) {
						t(i, i + 1, h._groupCompactness, .1), n[i] = 0, o[i++] = 0, n[i] = 0, o[i++] = 0
					})
				...
				this._directedLinkConstraints && (this.linkAccessor.getMinSeparation = this._directedLinkConstraints.getMinSeparation, u = u.concat(a.generateDirectedEdgeConstraints(j, this._links, this._directedLinkConstraints.axis, this.linkAccessor))), this.avoidOverlaps(!1), this._descent = new a.Descent([n, o], s), this._descent.locks.clear();
				for (var i = 0; j > i; ++i) {
					var v = this._nodes[i];
					if (v.fixed) {
						v.px = v.x, v.py = v.y;
						var w = [v.x, v.y];
						this._descent.locks.add(i, w)
					}
				}
				if (this._descent.threshold = this._threshold, this._descent.run(b), u.length > 0 && (this._descent.project = new a.vpsc.Projection(this._nodes, this._groups, this._rootGroup, u).projectFunctions()), this._descent.run(c), this.separateOverlappingComponents(l, m), this.avoidOverlaps(q), q && (this._nodes.forEach(function(a, b) {
						a.x = n[b], a.y = o[b]
					}), this._descent.project = new a.vpsc.Projection(this._nodes, this._groups, this._rootGroup, u, !0).projectFunctions(), this._nodes.forEach(function(a, b) {
						n[b] = a.x, o[b] = a.y
					})), this._descent.G = p, this._descent.run(e), f) {
					this._descent.snapStrength = 1e3, this._descent.snapGridSize = this._nodes[0].width, this._descent.numGridSnapNodes = j, this._descent.scaleSnapByMaxH = j != k;
					var x = a.Descent.createSquareMatrix(k, function(a, b) {
						return a >= j || b >= j ? p[a][b] : 0
					});
					this._descent.G = x, this._descent.run(f)
				}
				return this.updateNodePositions(), this.separateOverlappingComponents(l, m), g ? this.resume() : this
			}, d.prototype.separateOverlappingComponents = function(b, c) {
				var d = this;
				if (!this._distanceMatrix && this._handleDisconnected) {
					...
					var g = a.separateGraphs(this._nodes, this._links);
					a.applyPacking(g, b, c, this._defaultNodeSize), this._nodes.forEach(function(a, b) {
				...
				return this.alpha(0)
			}, d.prototype.prepareEdgeRouting = function(b) {
				void 0 === b && (b = 0), this._visibilityGraph = new a.geom.TangentVisibilityGraph(this._nodes.map(function(a) {
					return a.bounds.inflate(-b).vertices()
				}))
			}, d.prototype.routeEdge = function(b, c) {
				var d = [],
					e = new a.geom.TangentVisibilityGraph(this._visibilityGraph.P, {
					...
					h = e.addPoint(f, b.source.index),
					i = e.addPoint(g, b.target.index);
				e.addEdgeIfVisible(f, g, b.source.index, b.target.index), "undefined" != typeof c && c(e);
				var j = function(a) {
						return a.source.id
					},
					k = function(a) {
				...
				if (1 === n.length || n.length === e.V.length) {
					var o = a.vpsc.makeEdgeBetween(b.source.innerBounds, b.target.innerBounds, 5);
					d = [o.sourceIntersection, o.arrowStart]
				} else {
					for (var p = n.length - 2, q = e.V[n[p]].p, r = e.V[n[0]].p, d = [b.source.innerBounds.rayIntersection(q.x, q.y)], s = p; s >= 0; --s) d.push(e.V[n[s]].p);
					d.push(a.vpsc.makeEdgeTo(r, b.target.innerBounds, 5))
				}
				return d
			}, d.getSourceIndex = function(a) {
				return "number" == typeof a.source ? a.source : a.source.index
			}, d.getTargetIndex = function(a) {
				return "number" == typeof a.target ? a.target : a.target.index
			}, d.linkId = function(a) {
				return d.getSourceIndex(a) + "-" + d.getTargetIndex(a)
			}, d.dragStart = function(a) {
				b(a) ? d.storeOffset(a, d.dragOrigin(a)) : (d.stopNode(a), a.fixed |= 2)
			}, d.stopNode = function(a) {
				a.px = a.x, a.py = a.y
			}, d.storeOffset = function(a, b) {
				"undefined" != typeof a.leaves && a.leaves.forEach(function(a) {
					a.fixed |= 2, d.stopNode(a), a._dragGroupOffsetX = a.x - b.x, a._dragGroupOffsetY = a.y - b.y
				}), "undefined" != typeof a.groups && a.groups.forEach(function(a) {
					return d.storeOffset(a, b)
				})
			}, d.dragOrigin = function(a) {
				return b(a) ? {
					x: a.bounds.cx(),
					y: a.bounds.cy()
				} : a
			}, d.drag = function(a, c) {
				b(a) ? ("undefined" != typeof a.leaves && a.leaves.forEach(function(b) {
					a.bounds.setXCentre(c.x), a.bounds.setYCentre(c.y), b.px = b._dragGroupOffsetX + c.x, b.py = b._dragGroupOffsetY + c.y
				}), "undefined" != typeof a.groups && a.groups.forEach(function(a) {
					return d.drag(a, c)
				})) : (a.px = c.x, a.py = c.y)
			}, d.dragEnd = function(a) {
				b(a) ? ("undefined" != typeof a.leaves && a.leaves.forEach(function(a) {
					d.dragEnd(a), delete a._dragGroupOffsetX, delete a._dragGroupOffsetY
				}), "undefined" != typeof a.groups && a.groups.forEach(d.dragEnd)) : a.fixed &= -7
...
! function(a) {
	...
	var c = function(b) {
		function c(c) {
			b.call(this);
			var d = c;
			d.trigger && (this.trigger = d.trigger), d.kick && (this.kick = d.kick), d.drag && (this.drag = d.drag), d.on && (this.on = d.on), this.dragstart = this.dragStart = a.Layout.dragStart, this.dragend = this.dragEnd = a.Layout.dragEnd
		}
		return __extends(c, b), c.prototype.trigger = function(a) {}, c.prototype.kick = function() {}, c.prototype.drag = function() {}, c.prototype.on = function(a, b) {
			return this
		}, c
	}(a.Layout);
	a.LayoutAdaptor = c, a.adaptor = b
}(cola || (cola = {}));
var cola;
! function(a) {
	function b(a, b, d, e) {
		a.cola.start(0, 0, 0, 10, !1);
		var f = c(a.cola.nodes(), a.cola.groups(), d, e);
		return f.routeEdges(a.powerGraph.powerEdges, b, function(a) {
	...
	function c(b, c, d, e) {
		b.forEach(function(a) {
			a.routerNode = {
				name: a.name,
				bounds: a.bounds.inflate(-d)
			}
		}), c.forEach(function(a) {
			a.routerNode = {
				bounds: a.bounds.inflate(-e),
				children: ("undefined" != typeof a.groups ? a.groups.map(function(a) {
					return b.length + a.id
				}) : []).concat("undefined" != typeof a.leaves ? a.leaves.map(function(a) {
					return a.index
				}) : [])
			}
		});
		var f = b.concat(c).map(function(a, b) {
			return a.routerNode.id = b, a.routerNode
		});
		return new a.GridRouter(f, {
	...
	function d(b, c, d, e, f) {
		...
		b.nodes.forEach(function(a, b) {
			return a.index = b
		}), (new a.Layout).avoidOverlaps(!1).nodes(b.nodes).links(b.links).powerGraphGroups(function(a) {
			g = a, g.groups.forEach(function(a) {
				return a.padding = d
			})
		});
		var h = b.nodes.length,
			i = [],
			j = b.nodes.slice(0);
		return j.forEach(function(a, b) {
			return a.index = b
		}), g.groups.forEach(function(a) {
			var b = a.index = a.id + h;
			j.push(a), "undefined" != typeof a.leaves && a.leaves.forEach(function(a) {
				return i.push({
					source: b,
					target: a.index
				})
		...
		}), g.powerEdges.forEach(function(a) {
			i.push({
				source: a.source.index,
				target: a.target.index
			})
		}), (new a.Layout).size(c).nodes(j).links(i).avoidOverlaps(!1).linkDistance(30).symmetricDiffLinkLengths(5).convergenceThreshold(1e-4).start(100, 0, 0, 0, !1), {
			cola: (new a.Layout).convergenceThreshold(.001).size(c).avoidOverlaps(!0).nodes(b.nodes).links(b.links).groupCompactness(1e-4).linkDistance(30).symmetricDiffLinkLengths(5).powerGraphGroups(function(a) {
				g = a, g.groups.forEach(function(a) {
					a.padding = d
				})
			}).start(50, 0, 100, 0, !1),
	...
	a.gridify = b, a.powerGraphGridLayout = d
}(cola || (cola = {}));
var cola;
! function(a) {
	function b() {
	...
	var c = function(b) {
		function c() {
			b.call(this), this.event = d3.dispatch(a.EventType[a.EventType.start], a.EventType[a.EventType.tick], a.EventType[a.EventType.end]);
			var c = this;
			this.drag = function() {
				if (!b) var b = d3.behavior.drag().origin(a.Layout.dragOrigin).on("dragstart.d3adaptor", a.Layout.dragStart).on("drag.d3adaptor", function(b) {
					a.Layout.drag(b, d3.event), c.resume()
				}).on("dragend.d3adaptor", a.Layout.dragEnd);
				return arguments.length ? void this.call(b) : b
			}
		}
		return __extends(c, b), c.prototype.trigger = function(b) {
			var c = {
				type: a.EventType[b.type],
				alpha: b.alpha,
				stress: b.stress
			};
			this.event[c.type](c)
		}, c.prototype.kick = function() {
			var a = this;
			d3.timer(function() {
				return b.prototype.tick.call(a)
			})
		}, c.prototype.on = function(b, c) {
			return "string" == typeof b ? this.event.on(b, c) : this.event.on(a.EventType[b], c), this
		}, c
	}(a.Layout);
	a.D3StyleLayoutAdaptor = c, a.d3adaptor = b
}(cola || (cola = {}));
var cola;
! function(a) {
	var b = function() {
	...
	var e = function() {
		function d(d, e, f) {
			...
			q.forEach(function(a) {
				...
				g.nodes.forEach(function(b, d) {
					b.rect.lineIntersections(a.x1, a.y1, a.x2, a.y2).forEach(function(d, e) {
						var f = new c(g.verts.length, d.x, d.y, b, a);
						g.verts.push(f), a.verts.push(f), b.ports.push(f)
					})
				});
				var d = Math.abs(a.y1 - a.y2) < .1,
					e = function(a, b) {
						return d ? b.x - a.x : b.y - a.y
					};
				a.verts.sort(e);
				for (var f = 1; f < a.verts.length; f++) {
					var h = a.verts[f - 1],
						i = a.verts[f];
					h.node && h.node === i.node && h.node.leaf || g.edges.push({
						source: h.id,
						target: i.id,
						length: Math.abs(e(h, i))
					})
				}
			})
		}
		return d.prototype.avg = function(a) {
		...
		}, d.prototype.getGridLines = function(a) {
		...
		}, d.getSegmentSets = function(a, b, c) {
			...
			return a.GridRouter.nudgeSegments(i, "x", "y", h, c), a.GridRouter.nudgeSegments(i, "y", "x", h, c), a.GridRouter.unreverseEdges(i, g), i
		}, d.unreverseEdges = function(a, b) {
			a.forEach(function(a, c) {
				var d = b[c];
				d.reversed && (a.reverse(), a.forEach(function(a) {
					a.reverse()
				}))
			})
			...
			for (var c = [], e = 0; e < b.length - 1; e++)
				for (var f = e + 1; f < b.length; f++) {
					...
					0 !== l.length && (l.reversed && (k.reverse(), k.reversed = !0, l = new a.LongestCommonSubsequence(j, k)), (l.si <= 0 || l.ti <= 0) && (l.si + l.length >= j.length || l.ti + l.length >= k.length) ? c.push({
						l: e,
						r: f
					}) : (l.si + l.length >= j.length || l.ti + l.length >= k.length ? (g = j[l.si + 1], i = j[l.si - 1], h = k[l.ti - 1]) : (g = j[l.si + l.length - 2], h = j[l.si + l.length], i = k[l.ti + l.length]), d.isLeft(g, h, i) ? c.push({
						l: f,
						r: e
					}) : c.push({
						l: e,
		...
		}, d.getRoutePath = function(a, b, c, e) {
			var f = {
				routepath: "M " + a[0][0].x + " " + a[0][0].y + " ",
				arrowpath: ""
			};
			if (a.length > 1)
				for (var g = 0; g < a.length; g++) {
					var h = a[g],
						...
						l = j - h[0].y;
					if (g < a.length - 1) {
						Math.abs(k) > 0 ? i -= k / Math.abs(k) * b : j -= l / Math.abs(l) * b, f.routepath += "L " + i + " " + j + " ";
						var m = a[g + 1],
							n = m[0].x,
							o = m[0].y,
							p = m[1].x,
							q = m[1].y;
						k = p - n, l = q - o;
						var r, s, t = d.angleBetween2Lines(h, m) < 0 ? 1 : 0;
						Math.abs(k) > 0 ? (r = n + k / Math.abs(k) * b, s = o) : (r = n, s = o + l / Math.abs(l) * b);
						var u = Math.abs(r - i),
							v = Math.abs(s - j);
						f.routepath += "A " + u + " " + v + " 0 0 " + t + " " + r + " " + s + " "
					} else {
						var w, x, y = [i, j];
						Math.abs(k) > 0 ? (i -= k / Math.abs(k) * e, w = [i, j + c], x = [i, j - c]) : (j -= l / Math.abs(l) * e, w = [i + c, j], x = [i - c, j]), f.routepath += "L " + i + " " + j + " ", e > 0 && (f.arrowpath = "M " + y[0] + " " + y[1] + " L " + w[0] + " " + w[1] + " L " + x[0] + " " + x[1])
					}
				} else {
					var w, x, h = a[0],
						i = h[1].x,
...
! function(a) {
	...
	var d = function() {
		function b(a, c, d) {
			var e = this;
			void 0 === d && (d = 1), this.nodes = a, this.links = c, this.idealLinkLength = d, this.constraints = null, this.useJaccardLinkLengths = !0, this.result = new Array(b.k);
			for (var f = 0; f < b.k; ++f) this.result[f] = new Array(a.length);
			a.forEach(function(a, c) {
				for (var d = 0, f = b.dims; d < f.length; d++) {
					var g = f[d];
					"undefined" == typeof a[g] && (a[g] = Math.random())
				}
				e.result[0][c] = a.x, e.result[1][c] = a.y, e.result[2][c] = a.z
			})
		}
		return b.prototype.linkLength = function(a) {
			...
			var d = this.nodes.length,
				f = new e;
			this.useJaccardLinkLengths && a.jaccardLinkLengths(this.links, f, 1.5), this.links.forEach(function(a) {
				return a.length *= c.idealLinkLength
			});
			var g = new a.shortestpaths.Calculator(d, this.links, function(a) {
					return a.source
				}, function(a) {
					return a.target
				}, function(a) {
				...
				h = a.Descent.createSquareMatrix(d, function(a, b) {
					return g[a][b]
				}),
				i = a.Descent.createSquareMatrix(d, function() {
					return 2
				});
			this.links.forEach(function(a) {
				var b = a.source,
					c = a.target;
				return i[b][c] = i[c][b] = 1
			}), this.descent = new a.Descent(this.result, h), this.descent.threshold = .001, this.descent.G = i, this.constraints && (this.descent.project = new a.vpsc.Projection(this.nodes, null, null, this.constraints).projectFunctions());
			for (var j = 0; j < this.nodes.length; j++) {
				var k = this.nodes[j];
				k.fixed && this.descent.locks.add(j, [k.x, k.y, k.z])
			}
			return this.descent.run(b), this
		...
		}, b.dims = ["x", "y", "z"], b.k = b.dims.length, b
	}();
	a.Layout3D = d;
	var e = function() {
		function a() {}
