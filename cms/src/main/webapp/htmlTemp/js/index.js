...
function tab(){
	...
	for (var i = 0; i < aLi.length; i++) {
		...
		aLi[i].onmouseover=function(){
			for (var i = 0; i < aLi.length; i++) {
				aLi[i].className='';
				aI[i].style.background='#ebebeb';
				aI[i].style.color='#000';
				aSpan[i].style.color='#000';
			};
			this.className="on";
			aI[this.index].style.background='#47aaff';
			aI[this.index].style.color='#fff';
			aSpan[this.index].style.color='#47aaff';
		}
	};
}
...
function gotop(){
	...
	var oBtn1=document.getElementById('feedback');
	var oBtn2=document.getElementById('gotop');
