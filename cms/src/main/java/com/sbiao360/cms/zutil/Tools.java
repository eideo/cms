...
public class Tools {
	...
	//创建日期格式
	private static SimpleDateFormat chdf = new SimpleDateFormat("yyyy年MM月dd日   E");
	//创建中国的货币格式
	...
	public static void main(String[] args) throws IOException{
		...
		System.out.println(formatChDate(new Date()));
	...
	// 匹配地址对应的省份
		public static String getAreaByLocation(String location) {
			String area = "";
			if (null == location) {
				return area;
			}
