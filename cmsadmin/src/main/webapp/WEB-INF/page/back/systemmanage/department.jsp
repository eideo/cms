...
<div class="row">
	<div class="col-xs-12">
		<table id="grid-table-dept"></table>
...
<script type="text/javascript">
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		var grid_selector = "#grid-table-dept";
        		...
        		jQuery(grid_selector).jqGrid({
        			...
        			datatype : "json",
        			height : 450,
        			colNames : ['ID', '部门编码', '部门名称', '上级部门', '创建时间', '操作员', '备注', '操作'],
        			colModel : [ {
        				name : 'id',
        				index : 'id',
        				label : 'ID',
        				...
        				width : 60,
        				editable : true,
        				editoptions : {size : "27", maxlength : "32"},
        				formoptions : {elmsuffix : '<font color="red">*</font>'},
        				searchoptions : {sopt : ['eq']},
        				editrules : {required : true, custom : true, custom_func : deptKeyRuleFun}
        			}, {
        				name : 'deptName',
        				index : 'deptName',
        				label : '部门名称',
        				...
        				editrules : {required : true, custom : true, custom_func : deptNameRuleFun}
        			}, {
        				name : 'parentDeptName',
        				index : 'parentDeptKey',
        				label : '上级部门',
        				...
        				editable : true,
        				edittype : "select",
        				editoptions : {dataUrl : "${contextPath}/sys/department/getDeptSelectNoSelfList", title : "如果没有上级，不选即可"},
        				sortable : false,
        				search : false
        			}, {
        				name : 'createDateCn',
        				...
        				search : false,
        				edittype : 'textarea', 
        				editoptions : {rows : "2", cols : "25", maxlength : "60"}
        			},{
        				name : '',
        				index : '',
        				width : 80,
        				...
        				formatoptions : {
        					keys : true,
        					editbutton : <shiro:hasPermission name="${ROLE_KEY}:department:edit">true</shiro:hasPermission><shiro:lacksPermission name="${ROLE_KEY}:department:edit">false</shiro:lacksPermission>,
        					delbutton : <shiro:hasPermission name="${ROLE_KEY}:department:delete">true</shiro:hasPermission><shiro:lacksPermission name="${ROLE_KEY}:department:delete">false</shiro:lacksPermission>
        				}
        			} ],
        		...
        		function deptKeyRuleFun(value, colname) {
        			var reg = /^[A-Za-z0-9]+$/;
        			if (value == 0 || reg.test(value)) {
        				return [true,""];
        			} else {
        				return [false,"部门编码: 必须是由英文字母和数字组成的字符串"];
        			}
        		}
        		
        		function deptNameRuleFun(value, colname) {
        			var reg = /^[\u4e00-\u9fa5]{2,10}$/;
        			if (value == 0 || reg.test(value)) {
        				return [true,""];
        			} else {
        				return [false,"部门名称: 请填写正确的部门名称（汉字）"];
        			}
        		}
        	});
        });
