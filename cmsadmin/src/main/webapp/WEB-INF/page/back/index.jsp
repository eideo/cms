...
<html lang="zh-cn">
    ...
    <body class="no-skin">
            ...
            <div class="navbar-container" id="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    ...
                    <a href="#" class="navbar-brand">
                        <small>
                            <i class="fa fa-leaf"></i>CMS后台管理系统
                        </small>
                    </a>
                    <!-- /section:basics/navbar.layout.brand -->
                    ...
                    <ul class="nav ace-nav">
                        ...
                        <li class="light-blue">
                            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                <img class="nav-user-photo" src="${contextPath}/static/assets/avatars/profile-pic.jpg" alt="${sessionScope.SESSION_SYS_USER.loginId}" />
                                <span class="user-info">
                                    <small>
										欢迎您,
                                    </small>
									<c:out value="${sessionScope.SESSION_SYS_USER.custName}"/>
                                </span>
                ...
                <ul class="nav nav-list">
                	<c:forEach var="authority" items="${authorityList}">
	                	<c:if test="${authority.subAuthorityList.size() > 0}">
		                    <li class="">
		                        <a href="<c:out value='${authority.resourceUrl}'/>" class="dropdown-toggle">
		                            <i class="<c:out value='${authority.resourceClass}'/>"></i>
		                            <span class="menu-text"><c:out value="${authority.resourceName}"/></span>
		                        ...
		                        <ul class="submenu">
			                        ...
			                        <li class="">
		                                <a data-url="<c:out value='${subAuthorityList.resourceUrl}'/>" href="home#<c:out value='${subAuthorityList.resourceUrl}'/>">
		                                    <i class="<c:out value='${subAuthorityList.resourceClass}'/>"></i><c:out value="${subAuthorityList.resourceName}"/>
		                                </a>
		                                <b class="arrow"></b>
		                            </li>
		                            </c:forEach>
        ...
        <script type="text/javascript" src="${contextPath}/static/assets/js/custom/logout.js"></script>
    </body>
</html>
