								...
								<div id="member-tab" class="tab-pane">
									...
									<div class="clearfix">
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Bob Doe's avatar" src="${contextPath}/static/assets/avatars/profile-pic.jpg" />
											</div>
					...
					<div class="widget-body">
						<div class="widget-main no-padding">
							...
							<div class="dialogs">
								...
								<div class="itemdiv dialogdiv">
									<div class="user">
										<img alt="Bob's Avatar" src="${contextPath}/static/assets/avatars/profile-pic.jpg" />
									</div>
