...
public class PwdStuff {
	...
	public String convertPassword(String s) {
		...
		DES des = new DES();
		byte buf1[] = s.getBytes(), buf2[] = new byte[MIN_PASSWORD_LENGTH], buf3[] = new byte[MIN_PASSWORD_LENGTH];
		int i = buf1.length / MIN_PASSWORD_LENGTH
	...
	public static void main(String[] args) {
		...
		String id = "zaq12wsx";
		String eid = pwdStuff.convertPassword(id);
		System.out.println(eid);
		System.out.println("result is " + pwdStuff.correctPassword(id, eid));
	}
