package com.sbiao360.core.controller;
...
import com.sbiao360.core.support.ListView;
import com.sbiao360.core.web.CustomDateEditor;
...
public abstract class ExtJSBaseController<E extends ExtJSBaseParameter> {
	...
	public void doDelete(HttpServletRequest request,
		...
		// this.service.updateByProperties(this.idField, ids, new String[] {
		// this.statusField }, new Object[] { Integer.valueOf(-1) });
