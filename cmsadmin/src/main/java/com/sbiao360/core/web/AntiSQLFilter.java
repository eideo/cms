...
public class AntiSQLFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse resp,
		...
		if (isUnsafe(originalRequest.getParameterMap())
			...
			String behavior = filterConfig
					.getInitParameter(INIT_PARAM_BEHAVIOR);
			String forwardTo = filterConfig
					.getInitParameter(INIT_PARAM_FORWARDTO);
			...
			} else if (behavior.equalsIgnoreCase(BEHAVIOR_FORWARD)
					&& forwardTo != null) {
